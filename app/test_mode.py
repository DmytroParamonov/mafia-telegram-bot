...
async def test_command(message: Message) -> None:
    ...
    await message.answer(
        ...
        "Тут можна одному перевіряти локальні арти ПДА, 100 легенд, етапи, нічні меню, "
        "баланс, події, режим «Жива Зона» і симуляцію складу. Тест не записується в "
        "статистику й не запускає справжню партію.",
